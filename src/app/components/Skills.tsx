        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap -m-4">
            ...
            <div className="p-4 md:w-1/3">
              <div className="flex rounded-lg h-full bg-gray-200 p-8 flex-col">
                <div className="flex items-center mb-3">
                  <div className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-blue-500 text-black flex-shrink-0">
                    <svg
                      fill="none"
                      stroke="currentColor"
                      strokeLinecap="round"
                ...
                <div className="flex-grow">
                  <p className="leading-relaxed text-base text-black">
                     I work on projects (designing logos, brochures, flyers, websites, and advertisements)
